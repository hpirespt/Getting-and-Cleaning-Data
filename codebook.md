...
* subject: numeric value that goes from 1 to 30 that represents an identifier of the subject who did the experiment.
...
The set of variables that were estimated from these signals are ther mean value and standard deviation.

Below it's a complete list of the 66 features used in both tidy dataset that originates from the sensors. 
